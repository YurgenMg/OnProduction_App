...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    // Capturar si viene un error en los parámetros de búsqueda de la URL
    if (typeof window !== 'undefined') {
      const params = new URLSearchParams(window.location.search);
      const errorParam = params.get('error');
      if (errorParam === 'unauthorized') {
        setErrorMsg('Acceso no autorizado: Tu cuenta de Google no está pre-registrada en el sistema. Contacta a un administrador para recibir una invitación.');
      } else if (errorParam) {
    ...
    <div style={styles.container}>
      <div className="glass-panel" style={styles.loginCard}>
        ...
        <div style={styles.separatorContainer}>
          ...
          <span style={styles.separatorText}>o continúa con</span>
          <div style={styles.separatorLine}></div>
        </div>
        ...
        >
          ...
          <span style={styles.googleBtnText}>Continuar con Google</span>
        </button>
